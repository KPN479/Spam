...
# Recode Itu Gratis Kok

# Tapi Subrek Dulu YouTube Aing Slur
...
if not os.path.isfile('/data/data/com.termux/files/usr/bin/pyfiglet'):
    os.system('python -m pip install pyfiglet') ; os.system(f"python {sys.argv[0]}")
def jalan(ah):
    for i in ah + "\n":
        sys.stdout.write(i)
        sys.stdout.flush()
...
def subrek():
    os.system('clear')
    try:
        cek = open('subrek','r').read()
        os.system('clear')
    except IOError:
        save = open('subrek','w')
        save.write('Tools spam sms pertama punya aing slur')
        save.close()
        jalan('\033[1;96m➣ \033[1;97mSubrek YouTube Aing Dulu Slur')
        os.system('termux-open https://www.youtube.com/channel/UCofFWbMnIfs4AOCh4pChRAg')
        time.sleep(4)
        os.system('clear')
def logo():
    os.system('clear')
    print("\033[1;93m")
    os.system('pyfiglet -f graffiti "spammer"')
class nyepam:
	...
	def mulai(self):
		try:
			...
			exit("\033[1;94m[\033[1;97m✓\033[1;94m] \033[1;97mDone Slur")
		except reek.exceptions.ReadTimeout:exit("\n\033[1;91m[\033[1;97m×\033[1;91m] \033[1;97mKoneksi Terganggu\n")
		except reek.exceptions.ConnectionError:exit("\n\033[1;91m[\033[1;97m×\033[1;91m] \033[1;97mTidak Ada Koneksi\n")
		except (KeyboardInterrupt,EOFError):exit("\n\033[1;91m[\033[1;97m×\033[1;91m] \033[1;97mExit\n")
__import__("os").system("clear")
subrek()
logo()
while True:
	try:
		a=input("\033[1;94m[\033[1;97m✓\033[1;94m] \033[1;97mNomor Target \033[1;91m(\033[1;97m08\033[1;91m) \033[1;90m: \033[1;93m")
		asu=a[0:2]
		if a in(""," "):print("\033[1;96mJangan Kosong Dong Sayang")
		elif "08" not in asu:print("\033[1;96mGunakan Nomor Telpon Dengan Awalan 08")
		elif len(a)<=10:print("\033[1;96mNomor jangan kurang dari 10 angka slur")
		else:
			print()
			jalan("\033[1;96mSpam-sms dimulai | tekan CTRL + Z untuk berhenti")
			b=a[1:12] 
			c="62"+b
			nyepam(b,a,c).mulai()
			break
